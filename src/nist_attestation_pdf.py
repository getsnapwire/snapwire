...
def generate_nist_attestation_pdf(tenant_id=None):
    ...
    pdf.cell(0, 6, "Deterministic Agent Firewall - Feature-to-NIST Mapping", align="C", new_x="LMARGIN", new_y="NEXT")
    ...
    pdf.set_text_color(255, 140, 0)
    pdf.set_font("Helvetica", "B", 10)
    pdf.cell(0, 5, "SNAPWIRE - The Deterministic Agent Firewall", align="C", new_x="LMARGIN", new_y="NEXT")
    pdf.set_text_color(150, 150, 160)
    pdf.set_font("Helvetica", "", 8)
